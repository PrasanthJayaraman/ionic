...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__welcome_welcome__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__providers_helper_helper__ = __webpack_require__(209);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Home = (function () {
    function Home(helper, loadingCtrl, actionSheet, navParams, toast, network, sanitizer, modalCtrl, navCtrl, storage, platform, alertCtrl, firebase, authService, inAppBrowser, socialSharing) {
        var _this = this;
        this.helper = helper;
        ...
        if (platform.is('cordova')) {
            ...
            platform.registerBackButtonAction(function (e) {
                if (!_this.alertAlreadyPresent) {
                    _this.alertAlreadyPresent = true;
                    var alert_1 = alertCtrl.create({
                        ...
                        buttons: [{
                                ...
                                text: "Cancel",
                                role: 'cancel',
                                handler: function () { _this.alertAlreadyPresent = false; }
                            }]
                    });
                    alert_1.present();
                }
    ...
    Home.prototype.showModal = function () {
        if (this.pageHead == "Home" && this.isOnline && !this.fetching) {
            var modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_9__welcome_welcome__["a" /* WelcomePage */]);
            modal.present();
        }
    };
    ...
    Home.prototype.getData = function (page, index) {
        ...
        if (this.isOnline) {
            ...
            this.authService.getData(url)
                ...
                var newPosts = _this.helper.getPlatformHeight(temp.post, _this.content.contentHeight);
                ...
                if (newPosts && newPosts.length == 0) {
                    ...
                    _this.storage.get("ads")
                        .then(function (ads) {
                        loading_1.dismiss();
                        if (index > 1) {
                            var postsWithAd = _this.helper.concatPostAndAd(newPosts, ads, _this.index);
                            ...
                            var concated = _this.helper.concatPostAndAd(newPosts, ads, _this.index);
                            _this.posts = [];
...
Home = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-home',template:/*ion-inline-start:"/Users/apple/Documents/Ionic/ionic/src/pages/home/home.html"*/'<ion-header no-border>\n  <ion-navbar hideBackButton="true" color="secondary">\n    <ion-buttons left>\n      <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n    </ion-buttons>\n    <img src="assets/imgs/logo_white.png"  style="padding-top:5px;width:110px;height:40px" alt="">  \n    <ion-title class="toolbar-tit" style="margin-top:6px;">\n      {{pageHead.length > 12 ? pageHead.substring(0, 12) + \'...\' : pageHead}}\n    </ion-title>\n    <ion-buttons end>\n      <button (click)="doRefresh()" style="background-color: transparent; font-size: 28px;color:#fff">\n      <ion-icon name="refresh"></ion-icon>\n    </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header> \n\n<ion-content padding class="has-header no-scroll">         \n  <div *ngIf="posts?.length == 0">\n    <img src="assets/imgs/loader.jpg" class="loader" alt="">\n  </div>            \n  <ion-slides direction=\'vertical\' sensitivity="5" speed="200" effect="slide" loop="false" autoHeight="true" (ionSlideDidChange)="slideChanged()">                                                        \n    <ion-slide class="bg-white" *ngFor="let post of posts; let i = index" [style.height]="post.slideH">                                                         \n          <div [attr.id]="i" *ngIf="post && post.title">                \n                <div class="post-image-div" *ngIf="isOnline" [style.height]="post.imageH" [innerHTML]="post.newImage" >                                  \n                </div>   \n                <div *ngIf="!isOnline" class="post-image-div" [style.height]="post.imageH">                                    \n                  <img [attr.id]="post._id"  data-url="not online" [src]="post.image" class="post-image" alt="No image" crossOrigin="Anonymous" />\n                 </div>    \n                <div class="post-content-div" [style.height]="post.bodyH">\n                  <p class="title-text">{{post.title.length > 70 ? post.title.substring(0, 70) + "..." : post.title }}</p>\n                  <p class="body-text" [innerHtml]="post.body"></p>                  \n                </div>      \n                <div class="row buttons-row" [style.height]="post.footerH">\n                  <div class="column">            \n                    <button ion-button color="secondary" style="font-size:13px" (click)="openWithSystemBrowser(post.applyUrl)" outline>Read More</button>\n                  </div>\n                  <div class="column">            \n                      <button ion-button color="secondary" style="font-size:12px" (click)="openWithSystemBrowser(post.notifyUrl)" class="button" outline>Notification</button>\n                  </div>\n                  <div class="column">            \n                      <button ion-button color="secondary" style="font-size:13px" class="button" (click)="showShare(post.title, post.url)" outline>&nbsp; Share &nbsp;</button>\n                  </div>\n                  <div class="footer-text">\n                    <ion-icon name="arrow-up"></ion-icon>\n                    <span>FLIP UP FOR NEXT JOB</span>\n                  </div>\n                </div>\n          </div>    \n          <div *ngIf="post && post.script">\n              <div [innerHTML]="post.script">\n              </div>\n          </div>    \n        </ion-slide>       \n  </ion-slides>  \n</ion-content>\n\n\n   \n <!-- Patte Loper is a painter who experiments with sculpture and video. She was born in Colorado and grew up in Tallahassee,\n    FL, a subtropical college town where she first developed an appreciation for the ways nature and culture can overlap.\n    She currently lives and works in Brooklyn, NY, and Boston, MA, where she is on the faculty of the School of the\n    Museum of Fine Arts, Boston, MA. She has shown her work in numerous solo and group exhibitions internationally,\n    including the Drawing Center, New York, NY;       \n\n    <img [attr.id]="post._id"  data-url="not online" [src]="sanitizer.bypassSecurityTrustUrl(post.image)" class="post-image" alt="No image" crossOrigin="Anonymous" /> \n-->'/*ion-inline-end:"/Users/apple/Documents/Ionic/ionic/src/pages/home/home.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_10__providers_helper_helper__["a" /* HelperProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* ActionSheetController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ToastController */], __WEBPACK_IMPORTED_MODULE_5__ionic_native_network__["a" /* Network */], __WEBPACK_IMPORTED_MODULE_8__angular_platform_browser__["c" /* DomSanitizer */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_firebase__["a" /* Firebase */],
        __WEBPACK_IMPORTED_MODULE_4__providers_auth_service_auth_service__["a" /* AuthServiceProvider */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_in_app_browser__["a" /* InAppBrowser */], __WEBPACK_IMPORTED_MODULE_7__ionic_native_social_sharing__["a" /* SocialSharing */]])
], Home);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__ = __webpack_require__(19);
...
var HelperProvider = (function () {
    ...
    HelperProvider.prototype.getPlatformHeight = function (posts, totalHeight) {
        ...
        if (Object.keys(data).length > 0) {
            if (data) {
                ...
                this.asyncLoop(arr.length, function (loop) {
                    ...
                    _this.convertToDataURLviaCanvas(each.url, "image/png")
    ...
    HelperProvider.prototype.concatPostAndAd = function (posts, ads, index) {
        try {
            if (ads && ads.length > 0) {
                var position = 5; // count of posts you need to see between each ad
                var iteration = Math.floor(posts.length / 5);
                var adCount = ads;
                ...
                for (var _a = 0, posts_2 = posts; _a < posts_2.length; _a++) {
                    var item = posts_2[_a];
                    item.newImage = "<img data-url=\"online\" src=\"" + item.url + "\" class=\"post-image " + item._id + "\" alt=\"No image\" />";
                }
                return posts;
            ...
            for (var _b = 0, posts_3 = posts; _b < posts_3.length; _b++) {
                var item = posts_3[_b];
                item.newImage = "<img data-url=\"online\" src=\"" + item.url + "\" class=\"post-image " + item._id + "\" alt=\"No image\" />";
            }
            return posts;
    ...
    HelperProvider.prototype.convertToDataURLviaCanvas = function (url, outputFormat) {
...
HelperProvider = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_8__ionic_native_unique_device_id__["a" /* UniqueDeviceID */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ToastController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* ModalController */], __WEBPACK_IMPORTED_MODULE_5__ionic_storage__["b" /* Storage */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* Platform */], __WEBPACK_IMPORTED_MODULE_2__ionic_native_geolocation__["a" /* Geolocation */], __WEBPACK_IMPORTED_MODULE_3__ionic_native_location_accuracy__["a" /* LocationAccuracy */],
        __WEBPACK_IMPORTED_MODULE_4__ionic_native_diagnostic__["a" /* Diagnostic */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_6__ionic_native_firebase__["a" /* Firebase */], __WEBPACK_IMPORTED_MODULE_7__providers_auth_service_auth_service__["a" /* AuthServiceProvider */], __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__["c" /* DomSanitizer */]])
], HelperProvider);
...
var MyApp = (function () {
    ...
    MyApp.prototype.getAds = function () {
        var _this = this;
        this.storage.get("ads")
            .then(function (oldAds) {
            _this.ads = oldAds || [];
            _this.authService.getData("ads")
                .then(function (ads) {
                var temp;
                try {
...
var APIURL = "http://admin.jobswala.co/api/v1/";
/*
...
var AuthServiceProvider = (function () {
    ...
    AuthServiceProvider.prototype.alert = function (content) {
        var alert = this.alertCtrl.create({
            title: 'Alert',
            subTitle: content,
            buttons: ['Dismiss']
...
AuthServiceProvider = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["B" /* Injectable */])(),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */], __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["b" /* AlertController */]])
], AuthServiceProvider);
