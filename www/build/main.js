            ...
            this.authService.getData(url)
                ...
                if (newPosts && newPosts.length == 0) {
                    ...
                    _this.storage.get("ads")
                        ...
                        loading_1.dismiss();
                        if (index > 1) {
                            var postsWithAd = _this.helper.concatPostAndAd(newPosts, ads);
                            ...
                            var concated = _this.helper.concatPostAndAd(newPosts, ads);
                            _this.posts = [];
...
var APIURL = "https://jobswala.co/api/v1/";
/*
